...
dict set ap_memory_interface_dict B { MEM_WIDTH 64 MEM_SIZE 16 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	...
	{ B int 64 regular {array 2 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ B_address1 sc_out sc_lv 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "B", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	B { ap_memory {  { B_address0 mem_address 1 1 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 64 }  { B_address1 MemPortADDR2 1 1 }  { B_ce1 MemPortCE2 1 1 }  { B_q1 MemPortDOUT2 0 64 } } }
