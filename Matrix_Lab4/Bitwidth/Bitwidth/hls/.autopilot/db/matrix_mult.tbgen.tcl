...
dict set ap_memory_interface_dict A { MEM_WIDTH 8 MEM_SIZE 4 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict B { MEM_WIDTH 8 MEM_SIZE 4 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict AB { MEM_WIDTH 16 MEM_SIZE 8 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ A int 8 regular {array 4 { 1 1 } 1 1 }  }
	{ B int 8 regular {array 4 { 1 1 } 1 1 }  }
	{ AB int 16 regular {array 4 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "AB", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ AB_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "AB_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "AB", "role": "d0" }}  ]}

set ArgLastReadFirstWriteLatency {
	matrix_mult {
		A {Type I LastRead 1 FirstWrite -1}
		B {Type I LastRead 1 FirstWrite -1}
		AB {Type O LastRead -1 FirstWrite 4}}}
...
set Spec2ImplPortList { 
	A { ap_memory {  { A_address0 mem_address 1 2 }  { A_ce0 mem_ce 1 1 }  { A_q0 mem_dout 0 8 }  { A_address1 MemPortADDR2 1 2 }  { A_ce1 MemPortCE2 1 1 }  { A_q1 MemPortDOUT2 0 8 } } }
	B { ap_memory {  { B_address0 mem_address 1 2 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 8 }  { B_address1 MemPortADDR2 1 2 }  { B_ce1 MemPortCE2 1 1 }  { B_q1 MemPortDOUT2 0 8 } } }
	AB { ap_memory {  { AB_address0 mem_address 1 2 }  { AB_ce0 mem_ce 1 1 }  { AB_we0 mem_we 1 1 }  { AB_d0 mem_din 1 16 } } }
}
