...
// tvout file define:
#define AUTOTB_TVOUT_PC_AB "../tv/rtldatafile/rtl.matrix_mult.autotvout_AB.dat"
...
extern "C"
void apatb_matrix_mult_hw(void* __xlx_apatb_param_A, void* __xlx_apatb_param_B, void* __xlx_apatb_param_AB)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_AB),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_AB),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_AB),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_AB),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_AB),
#else
  ...
  port2.param = { __xlx_apatb_param_AB };
  port2.mname = { "AB" };
  port2.nbytes = { 16 };
  ...
  try {
    ...
    matrix_mult_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_AB);
