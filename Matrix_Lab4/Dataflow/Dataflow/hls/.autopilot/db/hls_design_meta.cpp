...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("AB_address0", 2, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("AB_ce0", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("AB_d0", 32, hls_out, 2, "ap_memory", "mem_din", 1),
	Port_Property("AB_q0", 32, hls_in, 2, "ap_memory", "mem_dout", 1),
	Port_Property("AB_we0", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("AB_address1", 2, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("AB_ce1", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("AB_d1", 32, hls_out, 2, "ap_memory", "mem_din", 1),
	Port_Property("AB_q1", 32, hls_in, 2, "ap_memory", "mem_dout", 1),
	Port_Property("AB_we1", 1, hls_out, 2, "ap_memory", "mem_we", 1),
