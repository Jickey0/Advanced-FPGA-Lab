...
dict set ap_memory_interface_dict A { MEM_WIDTH 32 MEM_SIZE 16 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict B { MEM_WIDTH 32 MEM_SIZE 16 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ A int 32 regular {array 4 { 1 1 } 1 1 }  }
	{ B int 32 regular {array 4 { 1 1 } 1 1 }  }
	{ AB int 32 regular {array 4 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ AB_address0 sc_out sc_lv 2 signal 2 } 
	{ AB_ce0 sc_out sc_logic 1 signal 2 } 
	{ AB_d0 sc_out sc_lv 32 signal 2 } 
	{ AB_q0 sc_in sc_lv 32 signal 2 } 
	{ AB_we0 sc_out sc_logic 1 signal 2 } 
	{ AB_address1 sc_out sc_lv 2 signal 2 } 
	{ AB_ce1 sc_out sc_logic 1 signal 2 } 
	{ AB_d1 sc_out sc_lv 32 signal 2 } 
	{ AB_q1 sc_in sc_lv 32 signal 2 } 
	{ AB_we1 sc_out sc_logic 1 signal 2 } 
...
set Spec2ImplPortList { 
	A { ap_memory {  { A_address0 mem_address 1 2 }  { A_ce0 mem_ce 1 1 }  { A_d0 mem_din 1 32 }  { A_q0 mem_dout 0 32 }  { A_we0 mem_we 1 1 }  { A_address1 MemPortADDR2 1 2 }  { A_ce1 MemPortCE2 1 1 }  { A_d1 mem_din 1 32 }  { A_q1 MemPortDOUT2 0 32 }  { A_we1 mem_we 1 1 } } }
	B { ap_memory {  { B_address0 mem_address 1 2 }  { B_ce0 mem_ce 1 1 }  { B_d0 mem_din 1 32 }  { B_q0 mem_dout 0 32 }  { B_we0 mem_we 1 1 }  { B_address1 MemPortADDR2 1 2 }  { B_ce1 MemPortCE2 1 1 }  { B_d1 mem_din 1 32 }  { B_q1 MemPortDOUT2 0 32 }  { B_we1 mem_we 1 1 } } }
	AB { ap_memory {  { AB_address0 mem_address 1 2 }  { AB_ce0 mem_ce 1 1 }  { AB_d0 mem_din 1 32 }  { AB_q0 mem_dout 0 32 }  { AB_we0 mem_we 1 1 }  { AB_address1 mem_address 1 2 }  { AB_ce1 mem_ce 1 1 }  { AB_d1 mem_din 1 32 }  { AB_q1 mem_dout 0 32 }  { AB_we1 mem_we 1 1 } } }
}
